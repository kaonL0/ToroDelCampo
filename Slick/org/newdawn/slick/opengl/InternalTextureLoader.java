...
public class InternalTextureLoader {
	...
	private HashMap<String, SoftReference<TextureImpl>> texturesLinear = new HashMap<>();
	/** The table of textures that have been loaded in this loader */
	private HashMap<String, SoftReference<TextureImpl>> texturesNearest = new HashMap<>();
	...
	public TextureImpl getTexture(InputStream in, String resourceName,
		...
		HashMap<String, SoftReference<TextureImpl>> hash = texturesLinear;
		...
		SoftReference<?> ref = hash.get(resName);
		if (ref != null) {
	...
	private TextureImpl getTexture(InputStream in, String resourceName,
		...
		GL11.glTexImage2D(target, 0, dstPixelFormat,
				...
				InternalTextureLoader.get2Fold(height), 0, srcPixelFormat,
