...
public class PBufferUniqueGraphics extends Graphics {
	...
	public PBufferUniqueGraphics(Image image) throws SlickException {
		...
		Log.debug("Creating pbuffer(unique) "+image.width()+"x"+image.height());
	...
	private void init() throws SlickException {
		try {
			Texture tex = InternalTextureLoader.get().createTexture(image.width(), image.height(), image.getFilter());
