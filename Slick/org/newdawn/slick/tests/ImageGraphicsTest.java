...
public class ImageGraphicsTest extends BasicGame {
	...
	public void render(GameContainer container, Graphics g) throws SlickException {
		...
		g.drawRect(300, 100, target.width(), target.height());
		g.drawRect(300, 410, target.width()/2, target.height()/2);
		g.drawRect(505, 410, target.width()/4, target.height()/4);
		...
		cut.draw(30,250);
		g.setColor(Color.white);
		g.drawRect(30, 250, cut.width(), cut.height());
		g.setColor(Color.gray);
		g.drawRect(xp, 50, cut.width(), cut.height());
		...
		g.drawRect(2,400,preloaded.width(),preloaded.height());
	}
